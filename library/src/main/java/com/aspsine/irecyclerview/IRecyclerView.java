...
public class IRecyclerView extends RecyclerView {
    ...
    private int maxLimitHeight = 200;
...
//        }
    ...
    public void setAutoLoadMore(boolean autoLoadMore) {
        ...
        if (!autoLoadMore && mLoadMoreFooterView != null && mLoadMoreFooterView instanceof LoadMoreTrigger) {
            ((LoadMoreTrigger) mLoadMoreFooterView).onClickReset();
        }
    }
    ...
    public void setLoadMoreFooterView(View loadMoreFooterView) {
        ...
        mLoadMoreFooterView.setOnClickListener(new OnClickListener() {
            ...
            public void onClick(View view) {
                if (onLoadMoreClickListener != null && !isNoData) {
                    if (mLoadMoreFooterView != null && mLoadMoreFooterView instanceof LoadMoreTrigger) {
                        ((LoadMoreTrigger) mLoadMoreFooterView).onClickStart();
                    }
...
//        int ratioDy = (int) (dy * 0.5f + 0.5f);
    ...
    private void move(int dy) {
        if (dy != 0) {
            ...
            if (height > maxLimitHeight) {
                setRefreshHeaderContainerHeight(maxLimitHeight);
